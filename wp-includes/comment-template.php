...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			...
			sprintf(
				'<input id="author" name="author" type="text" value="%s" placeholder="Your Name" size="30" maxlength="245"%s />',
		...
		'email'  => sprintf(
			...
			sprintf(
				'<input id="email" name="email" %s value="%s" placeholder="Your Email" size="30" maxlength="100" aria-describedby="email-notes"%s />',
