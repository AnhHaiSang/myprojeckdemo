	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item a.elementor-sub-item, {{WRAPPER}} a.elementor-sub-item' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item a:hover,
					{{WRAPPER}} ul.sub-menu li.menu-item a.elementor-item-active,
					{{WRAPPER}} ul.sub-menu li.menu-item a.highlighted,
					{{WRAPPER}} ul.sub-menu li.menu-item:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item:hover,
					{{WRAPPER}} ul.sub-menu li.menu-item a.elementor-item-active,
					{{WRAPPER}} ul.sub-menu li.menu-item a.highlighted' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item a.elementor-item-active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item a.elementor-item-active' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'line_height' ],
				'selector' => '{{WRAPPER}} ul.sub-menu li.menu-item a, {{WRAPPER}} .elementor-nav-menu--dropdown  .elementor-sub-item',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} ul.sub-menu li.menu-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} ul.sub-menu li.menu-item:first-child a' => 'border-top-left-radius: {{TOP}}{{UNIT}}; border-top-right-radius: {{RIGHT}}{{UNIT}};',
					'{{WRAPPER}} ul.sub-menu li.menu-item:last-child a' => 'border-bottom-right-radius: {{BOTTOM}}{{UNIT}}; border-bottom-left-radius: {{LEFT}}{{UNIT}};',
				],
			]
		);
