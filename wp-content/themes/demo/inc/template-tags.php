...
if ( ! function_exists( 'twentyseventeen_entry_footer' ) ) :
	...
	function twentyseventeen_entry_footer() {
		...
		// Get Tags for posts.
		$tags_list_entry = "No tag";

		$tags_list_icon = '<i class="fas fa-tags"></i>';
			...
			if ( 'post' === get_post_type() ) {
				if ( ( $categories_list && twentyseventeen_categorized_blog() ) || $tags_list ) {
					...
					if ( $tags_list && ! is_wp_error( $tags_list ) ) {
						echo '<span class="tags-links">' . $tags_list_icon . '<span class="screen-reader-text">' . __( 'Tags', 'twentyseventeen' ) . '</span>' . $tags_list . '</span>';
					}else {
						echo '<span class="tags-links">' . $tags_list_icon . '<span class="screen-reader-text">' . __( 'Tags', 'twentyseventeen' ) . '</span>' . $tags_list_entry . '</span>';
					}
